...
import '../screens/Assets/CSS/Home.css'
import {FaSearch} from 'react-icons/fa'
import {HiOutlineHome} from 'react-icons/hi'
import {TfiWorld} from 'react-icons/tfi'
import { TbBook2 } from 'react-icons/tb'
import { MdComputer, MdOutlineScience, MdCastForEducation } from 'react-icons/md'
import { RiBrush4Line, RiHeartPulseLine, RiHealthBookFill } from 'react-icons/ri'
import { GiFoodTruck, GiMaterialsScience } from 'react-icons/gi'
...
import {BsBagCheckFill ,BsFileSlides} from 'react-icons/bs'
                ...
                <div className='leftSection_container'>
                    <div className='introHeading_container'>
                        <div className='introHeading'>
                            <h2 className='introHeading_style text-center'>Find the</h2>
                        ...
                        <div className='jobSearch_container'>
                            <form className='jobSearch_intro'>
                                ...
                                <div className='introSubmit_container'>
                                    <button className='' type="submit"><FaSearch /></button>
                                </div>
                            </form>
                        </div>
                    </div>
                            ...
                            <div className="col-lg-3 col-md-6 col-12 mb-3">
                              <div className="card" style={{height:'20rem'}}>
                                 <div className="card-body " style={{display:'grid'}}>
                                   ...
                                   <h6 className="card-subtitle mb-2 text-muted text-center">Finince</h6>
                                  </div>
                                </div> 
                            </div>
                            ...
                            <div className="col-lg-3 col-md-6 col-12 mb-3">
                              <div className="card" style={{height:'20rem'}}>
                                 <div className="card-body " style={{display:'grid'}}>
                                   ...
                                   <h6 className="card-subtitle mb-2 text-muted text-center">Sales/Marketing</h6>
                                  </div>
                                </div> 
                            </div>
                            ...
                            <div className="col-lg-3 col-md-6 col-12 mb-3">
                              <div className="card" style={{height:'20rem'}}>
                                 <div className="card-body " style={{display:'grid'}}>
                                   ...
                                   <h6 className="card-subtitle mb-2 text-muted text-center">Education/Tranining</h6>
                                  </div>
                                </div> 
                            </div>
                            ...
                            <div className="col-lg-3 col-md-6 col-12 mb-3">
                              <div className="card" style={{height:'20rem'}}>
                                 <div className="card-body " style={{display:'grid'}}>
                                   ...
                                   <h6 className="card-subtitle mb-2 text-muted text-center">Technologies</h6>
                                  </div>
                                </div> 
                            </div>
                            ...
                            <div className="col-lg-3 col-md-6 col-12 mb-3">
                              <div className="card" style={{height:'20rem'}}>
                                 <div className="card-body " style={{display:'grid'}}>
                                   ...
                                   <h6 className="card-subtitle mb-2 text-muted text-center">Art/Design</h6>
                                  </div>
                                </div> 
                            </div>
                            ...
                            <div className="col-lg-3 col-md-6 col-12 mb-3">
                              <div className="card" style={{height:'20rem'}}>
                                 <div className="card-body " style={{display:'grid'}}>
                                   ...
                                   <h6 className="card-subtitle mb-2 text-muted text-center">Healthcare</h6>
                                  </div>
                                </div> 
                            </div>
                            ...
                            <div className="col-lg-3 col-md-6 col-12 mb-3">
                              <div className="card" style={{height:'20rem'}}>
                                 <div className="card-body " style={{display:'grid'}}>
                                   ...
                                   <h6 className="card-subtitle mb-2 text-muted text-center">Science</h6>
                                  </div>
                                </div> 
                            </div>
                            ...
                            <div className="col-lg-3 col-md-6 col-12 mb-3">
                              <div className="card" style={{height:'20rem'}}>
                                 <div className="card-body " style={{display:'grid'}}>
                                   ...
                                   <h6 className="card-subtitle mb-2 text-muted text-center">Food Service</h6>
                                  </div>
                                </div> 
                            </div>
                        </div>
