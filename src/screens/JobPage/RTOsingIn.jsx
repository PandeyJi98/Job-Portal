...
import "../Assets/CSS/RTOLogin.css";

const RTOLogin = () => {
  return (
    <div className="parent">
      {/* <div> */}
      {/* <img src="https://s.cdpn.io/13034/car.png"  className="car" width="220" height="100px"/> */}
      {/* <h3>Scanning...</h3> */}
      {/* </div> */}
  ...
  <div className="hero">
        ...
        <div className="city"></div>
          <div className="car">
          <img className="carImage" src="https://i.ibb.co/sK5GKp2/car.png" alt="car" border="0" />
        </div>
        <div className="wheel">
          <img
            src="https://i.ibb.co/TLCFGZP/wheel.png"
            alt="wheel"
            border="0"
            className="backwheel bothWheel"
          ...
          <img
            ...
            alt="wheel"
            border="0"
            className="frontwheel bothWheel"
            style={{ left: "px", top: "px" }}
          />
        </div>
  {/* Form start here */}
  <div className="main">
          ...
          <form className="form">
            ...
            <div class="scan">
              ...
              {/* <h3 className="scanning">Scanning...</h3> */}
            </div>
          </form>
          </div>
          ...
          <form className="form2">
            <label className="label1" htmlFor="chk" aria-hidden="true" style={{paddingBottom:'21px'}}>
              Register
            </label>
            <input
              className="input"
